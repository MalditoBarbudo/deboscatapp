...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[14]]`: 07-026 seems the continuation of 07-019 for 2020,
  fix it
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[15]]`: 10-004 polygon for 2015 is wrong, fix it.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[15]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[16]]`: 10-040 is exactly the same as 19-040. Remove it
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[16]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[17]]`: Exactly the same as before.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[17]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[18]]`: New episode years later in the same place, no fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[18]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[19]]`: 14-066 for 2020 is really 14-013, fix it
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[19]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[20]]`: What??, and see `r data_muddy_episodes_centroids_intersection[[23]]`
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[20]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[21]]`: Really??, 2 episodes?? No fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[21]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[22]]`: Inexplicable, no fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[22]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[23]]`: Really?? and see `r data_muddy_episodes_centroids_intersection[[20]]`. It seems like the 2017 is a mix of the three, who knows.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[23]], data_muddy_deboscat_checks)
create_polygon_plot_2(
  c(data_muddy_episodes_centroids_intersection[[20]], data_muddy_episodes_centroids_intersection[[23]]),
  data_muddy_deboscat_checks
)
```

  1. `r data_muddy_episodes_centroids_intersection[[24]]`: 14-078 dance around 14-075 along the years, yujuu!.
  No fix.
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[25]]`: 16-002 for 2014 is a copy of 16-003, remove it
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[25]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[26]]`: 19-002 is broken in two parts in 2016, no fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[26]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[27]]`: 20-012-2012 is really 20-005, fix it
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[27]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[28]]`: Let's broke the episodes in pieces!! No fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[28]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[29]]`: 21-031 in 2018 (only year available for this episode)
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[30]]`: New episode after years, no fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[30]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[31]]`: 38-002 in 2012 is a duplicated of 23-002. Also,
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[32]]`: 24-001 in 2012 is really 24-032. Fix it.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[32]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[33]]`: 24-016 in 2019 is really 24-106. Fix it.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[33]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[34]]`: Two different episodes, no fix.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[34]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[35]]`: 2Two different episodes, no fix.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[35]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[36]]`: 24-043 in 2012 is a duplicated of 24-044, remove
  it.
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[48]]`: 27-001 in 2017 is in reality 28-001. Fix it
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[48]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[49]]`: No idea, no fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[49]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[50]]`: 31-001-2012 is in reality 31-007-2015
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[50]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[51]]`: 31-007-2012 is in reality 31-001-2015
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[51]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[52]]`: 31-002-2012 is in reality 31-008-2016
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[52]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[53]]`: 31-008-2012 is in reality 31-002-2015
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[53]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[54]]`: Different episodes in different years
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[54]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[55]]`: Different episodes in different years, as before
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[55]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[56]]`: Different episodes in different years, as before
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[56]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[57]]`: Different episodes after one year??? No fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[57]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[58]]`: What the fuck??? No fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[58]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[59]]`: Another classic, dancing episodes, come and see!!
