...
+ Code reuse cases:
  ...
  - "13-001": More than 5km of difference, its clear is a new episode, so we change the code in past episodes
  - "21-031": More than 2km of difference, its clear is a new episode, so we change the code in past episodes
  - "34-056": More than 17km of difference, its clear is a new episode, so we change the code in past episodes
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[11]]`: A different episode years after, no fix here
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[11]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[12]]`: Same as before, no fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[12]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[13]]`: Episodes evolving, no fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[13]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[19]]`: 07-026 seems the continuation of 07-019 for 2020,
  fix it
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[20]]`: 10-004 polygon for 2015 is wrong, fix it.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[20]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[22]]`: 10-040 is exactly the same as 19-040. Remove it
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[22]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[23]]`: Exactly the same as before.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[23]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[24]]`: New episode years later in the same place, no fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[24]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[25]]`: 14-066 for 2020 is really 14-013, fix it
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[25]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[26]]`: What??, and see `r data_muddy_episodes_centroids_intersection[[29]]`
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[26]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[27]]`: Really??, 2 episodes?? No fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[27]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[28]]`: Inexplicable, no fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[28]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[29]]`: Really?? and see `r data_muddy_episodes_centroids_intersection[[26]]`. It seems like the 2017 is a mix of the three, who knows.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[29]], data_muddy_deboscat_checks)
create_polygon_plot_2(
  c(data_muddy_episodes_centroids_intersection[[26]], data_muddy_episodes_centroids_intersection[[29]]),
  data_muddy_deboscat_checks
)
```

  1. `r data_muddy_episodes_centroids_intersection[[30]]`: 14-078 dance around 14-075 along the years, yujuu!.
  No fix.
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[31]]`: 16-002 for 2014 is a copy of 16-003, remove it
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[31]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[32]]`: 19-002 is broken in two parts in 2016, no fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[32]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[33]]`: 20-012-2012 is really 20-005, fix it
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[33]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[34]]`: Let's broke the episodes in pieces!! No fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[34]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[35]]`: 21-031-2020 in 2018 (only year available for this episode)
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[36]]`: New episode after years, no fix
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[36]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[37]]`: 38-002 in 2012 is a duplicated of 23-002. Also,
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[38]]`: 23-010 and 23-011 are exchanged in 2021. Fix it.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[38]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[39]]`: 24-001 in 2012 is really 24-032. Fix it.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[39]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[40]]`: 24-016 in 2019 is really 24-106. Fix it.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[40]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[41]]`: Two different episodes, no fix.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[41]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[42]]`: 2Two different episodes, no fix.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[42]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[43]]`: 24-043 in 2012 is a duplicated of 24-044, remove
  it.
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[44]]`: Not sure what happened here, no fix.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[44]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[45]]`: Not sure what happened here, no fix.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[45]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[46]]`: 24-073-2015 is a duplicated of 24-064, remove it
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[46]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[47]]`: No idea, no fix.
  
```{r}
create_polygon_plot_2(data_muddy_episodes_centroids_intersection[[47]], data_muddy_deboscat_checks)
```

  1. `r data_muddy_episodes_centroids_intersection[[48]]`: Different episodes after years, no fix
...
```
  ...
  1. `r data_muddy_episodes_centroids_intersection[[79]]`: 40-019 seems to be part of the old 40-003, so I
